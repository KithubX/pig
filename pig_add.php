<?php
// >> START OF "on begin of page" [BOF001] [INLINE] [START] [SRV] [1B213019-DC7B-40AE-AB03-991F74A7C98F] [Add Pig]
...
$inlineHtml = "";
$inlineHtml .= "<Form name=\"qs_add_form\" method=\"post\" action=\"./pig_add.php\" onSubmit=\"return qsFormOnSubmitController_add(this)\"  onReset=\"return qsPageOnResetController_add(this)\" >";
...
$css_class = "\"Pig_3_OddDataText\"";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td colspan=\"2\" class=\"Pig_3_TableTitle\">Add Pig</td>";
$inlineHtml .= "</tr>";
...
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_EmployeeCode_label\">EmployeeCode</span></td>";
...
if ((!isset($_GET["add_fd0"])) && (!isset($_POST["add_fd0"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_EmployeeCode_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_FirstName_label\">FirstName</span></td>";
...
if ((!isset($_GET["add_fd1"])) && (!isset($_POST["add_fd1"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_FirstName_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_LastName_label\">LastName</span></td>";
...
if ((!isset($_GET["add_fd2"])) && (!isset($_POST["add_fd2"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_LastName_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_Title_label\">Title</span></td>";
...
if ((!isset($_GET["add_fd3"])) && (!isset($_POST["add_fd3"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_Title_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_Department_label\">Department</span></td>";
...
if ((!isset($_GET["add_fd4"])) && (!isset($_POST["add_fd4"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_Department_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_Address_label\">Address</span></td>";
...
if ((!isset($_GET["add_fd5"])) && (!isset($_POST["add_fd5"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_Address_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_City_label\">City</span></td>";
...
if ((!isset($_GET["add_fd6"])) && (!isset($_POST["add_fd6"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_City_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_Country_label\">Country</span></td>";
...
if ((!isset($_GET["add_fd7"])) && (!isset($_POST["add_fd7"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_Country_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_Phone_label\">Phone</span></td>";
...
if ((!isset($_GET["add_fd8"])) && (!isset($_POST["add_fd8"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_Phone_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_PhoneExt_label\">PhoneExt</span></td>";
...
if ((!isset($_GET["add_fd9"])) && (!isset($_POST["add_fd9"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_PhoneExt_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\"><span id=\"Pig_3_MobileNo_label\">MobileNo</span></td>";
...
if ((!isset($_GET["add_fd10"])) && (!isset($_POST["add_fd10"]))) {
    ...
    $inlineHtml .=  "<td class=" . $css_class . " style=\"text-align:Default\" ><span id=\"Pig_3_MobileNo_value\"";
$inlineHtml .=  ">" . $cellvalue . "</span></td>";
$inlineHtml .= "</tr>";
...
#----get back url page----
  $backurl = "./pig.php?";
$inlineHtml .= "<tr>";
$inlineHtml .= "<td class=\"Pig_3_TableText\">&nbsp;</td>";
$inlineHtml .= "<td class=\"Pig_3_TableButtons\">";
$inlineHtml .= "<input type=\"hidden\" name=\"act\" value=\"n\">";
$inlineHtml .=  "<input type=\"button\" value=\"Cancel\" onclick=\"hidePanel();\" /> ";
$inlineHtml .= "<input type=\"submit\" name=\"QS_Submit\" value=\"Add\">&nbsp;&nbsp;";
