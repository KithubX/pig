...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
		<table  class="main" width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
		  <tr>
			<td class="header" align="left" colspan="2">&nbsp;ASPInfo&nbsp;</td>
		  </tr>
		  <tr>
			<td width="150" nowrap class="title">Date</td>
			<td class="cell"><%= formatdatetime(now(),1)%></td>
		  </tr>
		  <tr>
			<td width="150" nowrap class="title">Script&nbsp;URL</td>
			<td class="cell">http://<%= Request.ServerVariables("SERVER_NAME") & Request.ServerVariables("PATH_INFO")%></td>
		  </tr>
		  <tr>
			<td width="150" nowrap class="title">Physical&nbsp;Path</td>
			<td class="cell"><%=  Server.MapPath(Request.ServerVariables("SCRIPT_NAME")) %></td>
		  </tr>
		</table>
	</td>
  </tr>
    ...
    <td>
		<table  class="main" width="100%" border="0" cellspacing="2" cellpadding="2" align="center">
		  ...
		  <tr>
			...
			<td class="cell"><%=  Request.ServerVariables("SERVER_NAME") %></td>
		  </tr>
		  <tr>
			<td width="150" nowrap class="title">Server&nbsp;IP&nbsp;Address</td>
			<td class="cell"><%=  Request.ServerVariables("LOCAL_ADDR") %></td>
		  </tr>
		  <tr>
		    <td width="150" nowrap class="title">Server&nbsp;Port</td>
		    <td class="cell"><%= Request.ServerVariables("SERVER_PORT") %></td>
	      </tr>
		  <tr>
		    <td width="150" nowrap class="title">Server&nbsp;Software</td>
		    <td class="cell"><%=  Request.ServerVariables("SERVER_SOFTWARE") %></td>
	      </tr>
		  <tr>
		    <td width="150" nowrap class="title">Operating&nbsp;System</td>
		    <td class="cell"><%=  Request.ServerVariables("OS") %></td>
	      </tr>
  ...
  <tr>
    <td align="center"><a href="aspinfo.asp">More</a></td>
  </tr>
</table>
</body>
</html>
