...
Sub Display_Header()
	Response.Write  "	<p>" & vbNewLine & _
			"	<table class=""main"" cellspacing=""1"" align=""center"" style=""width:100%;"">" & vbNewLine & _
			"		<tr>" & vbNewLine & _
...
Sub Display_Server_Information()
	Response.Write  "	<p>" & vbNewLine & _
			...
			"		</tr>" & vbNewLine & _
			"		<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Info&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Value&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine & _
...
Sub Display_Application_Object()
	Response.Write  "	<p>" & vbNewLine & _
			...
			"		</tr>" & vbNewLine & _
			"		<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Variable&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Value&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine
	INT_COUNT = 0
...
Sub Display_Request_Object()
	Response.Write  "	<p>" & vbNewLine & _
			...
			"		</tr>" & vbNewLine & _
			"		<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;ClientCertificate&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Value&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine
	INT_COUNT = 0
	...
	End If
	Response.Write	"       	<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Cookies&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Value&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine
	INT_COUNT = 0
...
Sub Display_Response_Object()
	Response.Write  "	<p>" & vbNewLine & _
			...
			"		</tr>" & vbNewLine & _
			"		<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Attribute&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Value&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine & _
...
Sub Display_All_Components()
	...
	INT_COUNT = 0
	On Error Resume Next
	For INT_COUNT2 = 0 To UBound(ARR_COMPONENTS) -1
		Err = 0
	...
	STR_TEMP =      "	<p>" & vbNewLine & _
			...
			"		</tr>" & vbNewLine & _
			"		<tr>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Component&nbsp;</td>" & vbNewLine & _
			"			<td class=""header2"" width=""50%"" align=""center"">&nbsp;Version&nbsp;</td>" & vbNewLine & _
			"		</tr>" & vbNewLine & _
			STR_TEMP & _
			"	</table>" & vbNewLine & _
			"	</p>" & vbNewLine
...
.cell { background-color:#F1F4F7; padding:4px; font-size:10px; }
...
'Call Display_All_Components() 'It's too slow.
